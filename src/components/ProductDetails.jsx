...
function ProductDetails(props) {
  ...
  React.useEffect(() => getProduct(props.match.params.productId, data => data.status === 200 ? setProductDetails(data.details) : setProductDetails(productDetails)),[]);
    ...
    <div className = 'product_details'>
      ...
      <div className = 'product_main'>
        <div className = 'product_image'>
          ...
          <img src = {productDetails.image} alt = {productDetails.description} className = 'img-fluid img-responsive img-rounded'/>
